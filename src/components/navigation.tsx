                            ...
                            <div className="fixed bottom-20 sm:bottom-32 left-4 sm:left-8 flex flex-col items-start justify-center gap-4">
                                <MobileLink href="/experience">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" aria-hidden>
                                        ...
                                        <path fill="currentColor" fillRule="evenodd" d="M7.5 5.25a3 3 0 0 1 3-3h3a3 3 0 0 1 3 3v.25h.75a3 3 0 0 1 3 3v1.25a.75.75 0 0 1-.75.75h-15a.75.75 0 0 1-.75-.75V8.5a3 3 0 0 1 3-3h.75zm1.5 0v.25h6v-.25a1.5 1.5 0 0 0-1.5-1.5h-3a1.5 1.5 0 0 0-1.5 1.5" clipRule="evenodd" />
                                        <path fill="currentColor" fillRule="evenodd" d="M3.75 11.25a.75.75 0 0 1 .75-.75h15a.75.75 0 0 1 .75.75v8.5a3 3 0 0 1-3 3h-10.5a3 3 0 0 1-3-3zM9 15.75a.75.75 0 0 0 0 1.5h6a.75.75 0 0 0 0-1.5z" clipRule="evenodd" />
                                    </svg>
                                    Experience
                                </MobileLink>
